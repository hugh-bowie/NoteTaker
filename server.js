...
app.post('/api/notes', (req, res) => {
	...
	fs.writeFile('./db/db.json', JSON.stringify(database), err => (err ? console.log(err) : console.log('Note saved.')));
...
app.delete('/api/notes/:id', (req, res) => {
	...
	fs.writeFile('./db/db.json', JSON.stringify(database), err => (err ? console.log(err) : console.log('Note deleted.')));
